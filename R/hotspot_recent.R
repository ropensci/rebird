...
#' and reported at birding hotspots.
...
#' @export
#' @examples \dontrun{
#' hotspot_recent(c('L99381','L99382'))
#' hotspot_recent(c('L99381','L99382'), maxResults=10, includeProvisional=T, hotspot=T)
#' }
...
hotspot_recent <-  function(LocIDs, back = NA, maxResults = NA, 
